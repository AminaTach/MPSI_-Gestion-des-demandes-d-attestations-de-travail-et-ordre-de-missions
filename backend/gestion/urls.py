...
from gestion.views import (
    ...
    delete_demande_attestation, delete_mission_order, generate_mission_order, generate_work_certificate, 
    get_mission_order_details, get_user_demandes_attestation, get_user_demandes_ordre_mission, 
    ...
    get_user_documents, update_demande_attestation_status, update_demande_ordre_mission_status, 
