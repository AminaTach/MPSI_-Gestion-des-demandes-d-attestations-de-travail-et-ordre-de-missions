...
export default function RH_docs() {
  ...
  return (
    <div className="w-full h-screen pb-4 font-nunito sm:w-[3/4]">
      <Header />
      <div className="bg-blue-50  h-full p-4 md:p-8 min-h-screen w-full">
        ...
        <div className="flex border-b w-full justify-center items-center border-gray-200 mb-6">
          <div className="w-1/2">
            <button
              className={`px-4 py-2 font-medium flex items-center gap-2 ${activeTab === "attestation"
          ...
          <div className="w-1/2">
            <button
              className={`px-4 py-2 font-medium flex items-center gap-2 ${activeTab === "mission"
                  ? "text-blue-500 border-b-2 border-blue-500"
                  : "text-gray-500"
                }`}
