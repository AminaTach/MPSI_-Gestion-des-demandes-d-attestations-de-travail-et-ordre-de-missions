              ...
              <div className="space-y-2 mb-4">
                <div className="flex items-center">
                  <input 
                    ...
                    id="statusPending" 
                    className="mr-2"
                    checked={activeFilters.status.includes('En attente')}
                    onChange={(e) => {
                      const newStatus = e.target.checked 
                        ? [...activeFilters.status, 'En attente']
                        : activeFilters.status.filter(s => s !== 'En attente');
            ...
            <div className="border-t pt-4">
              ...
              {selectedDemande.type === 'Ordre de mission' ? (
                <div className="space-y-2">
                  <p><span className="text-gray-500">Nom complet:</span> {selectedDemande.fullName}</p>
                  <p><span className="text-gray-500">Département:</span> {selectedDemande.department}</p>
                  <p><span className="text-gray-500">Poste:</span> {selectedDemande.position}</p>
                  <p><span className="text-gray-500">Période:</span> Du {formatDate(selectedDemande.startDate)} au {formatDate(selectedDemande.endDate)}</p>
                  <p><span className="text-gray-500">Objet de la mission:</span> {selectedDemande.purpose}</p>
                </div>
              ) : (
                <div>
